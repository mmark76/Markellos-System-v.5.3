...
stories.push(phrase.trim());
    ...
    const prologue = `Ο Γέροντας ανοίγει το παλιό σκονισμένο βιβλίο και λέει στο μικρό σκακιστή ...\n Σήμερα θα μελετήσουμε τη μάχη ανάμεσα στους δύο μεγάλους στρατηγούς ... και ανοίγει το αρχαίο, πολύτιμο βιβλίο, μετροφυλλάει κάποιες σελίδες και ξεκινάει να διαβάζει...\n `;
