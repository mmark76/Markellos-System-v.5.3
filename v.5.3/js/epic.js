...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateEpicText() {
    ...
    const prologue = ` Ο Γέροντας άνοιξε το παλιό σκονισμένο βιβλίο και είπε στο μικρό μαθητή: "Σήμερα θα μελετήσουμε τη μάχη ανάμεσα σε δύο μεγάλους στρατηγούς: ${white}, εναντίον ${black}. Την ${formattedDate}, συναντήθηκαν για αυτή την αναμέτρηση." `;
