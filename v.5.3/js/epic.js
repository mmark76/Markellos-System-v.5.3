...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function buildEpicSentence(locus, colorW, pieceAssocW, sanW, targetAssocW,
    ...
    const templates = [
      `${locus} από όπου ξεπροβάλλει ${pieceAssocW}, και με την κίνηση ${sanW}, ${targetAssocW}, ... . Από το αντίστοιχο μαύρο σημείο, ξεπροβάλλει ${pieceAssocB} ..., και με την κίνηση ${sanB}, ${targetAssocB}.`
    ];
