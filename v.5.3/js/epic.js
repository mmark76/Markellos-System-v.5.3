...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function buildEpicSentence(locus, colorW, pieceAssocW, sanW, targetAssocW,
    ...
    const templates = [
      `${locus} ξεπροβάλλει ${pieceAssocW}, και με την κίνηση ${sanW}, ${targetAssocW}. Η ενέργεια του λευκού ταξιδεύει μέσα στο χώρο· και σαν αντίλαλος ξεπροβάλλει ${pieceAssocB}, και με την κίνηση ${sanB}, ${targetAssocB}.`
    ];
