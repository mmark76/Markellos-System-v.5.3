...
stories.push(phrase.trim());
    ...
    const prologue = `Ο Γέροντας παίρνει στα χέρια του με μεγάλη προσοχή ένα βιβλίο και λέει στο μικρό σκακιστή ...\n Σήμερα θα μελετήσουμε τη μάχη ανάμεσα στους δύο μεγάλους στρατηγούς,  που σου ανέφερα τα ονόματα, ... και ανοίγει το αρχαίο, πολύτιμο βιβλίο, μετροφυλλάει κάποιες σελίδες και ξεκινάει να διαβάζει...\n `;
