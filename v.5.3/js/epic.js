...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateEpicText() {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      let sceneNumber = i + 1; // αριθμός σκηνής (ξεκινά από 1)
      let phrase = `Σκηνή ${sceneNumber}: ${locus}, `;
    ...
    const prologue = ` Ο Γέροντας ανοίγει το παλιό σκονισμένο βιβλίο και λέει στο μικρό μαθητή: "Σήμερα θα μελετήσουμε τη μάχη ανάμεσα στους δύο προαναφερόμενους μεγάλους στρατηγούς:" ... Και γυρνώντας την παλιά σελίδα ξεκίνησε να διαβάζει...\n `;
    
    let finalMsg = "";
    if (result === "1-0") finalMsg = " \n … και μετά την τελευταία κίνηση, ο μαύρος Στρατηγός κατάλαβε πως η μάχη είχε κριθεί. Έσκυψε το κεφάλι του αργά, και δίνοντας το χέρι του στον αντίπαλο Στρατηγό, παραδόθηκε με αξιοπρέπεια. Επικράτησε ηρεμία από την ηχώ της μάχης, και ο Γέροντας έκλεισε το παλιό σκονισμένο βιβλίο και η παρτίδα έγινε ανάμνηση για πάντα στη μνήμη και την ιστορία.";
    else if (result === "0-1") finalMsg = " \n … και μετά την τελευταία κίνηση, ο λευκός Στρατηγός κατάλαβε πως η μάχη είχε κριθεί. Έσκυψε το κεφάλι του αργά, και δίνοντας το χέρι του στον αντίπαλο Στρατηγό, παραδόθηκε με αξιοπρέπεια. Επικράτησε ηρεμία από την ηχώ της μάχης, και ο Γέροντας έκλεισε το παλιό σκονισμένο βιβλίο και η παρτίδα έγινε ανάμνηση για πάντα στη μνήμη και την ιστορία.";
    else if (result === "1/2-1/2") finalMsg = " \n … και μετά την τελευταία κίνηση, οι δύο Στρατηγοί καταλαβαίνουν ότι κανείς δεν μπορεί να κερδίσει αυτή τη μάχη και δίνουν τα χέρια και η μάχη λήγει ισόπαλη... και επικράτησε ηρεμία από την ηχώ της μάχης. Ο Γέροντας έκλεισε το παλιό σκονισμένο βιβλίο και η παρτίδα έγινε ανάμνηση για πάντα στη μνήμη και την ιστορία.";
