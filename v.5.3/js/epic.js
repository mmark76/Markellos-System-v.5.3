...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateEpicText() {
    ...
    const prologue = ` Ο Γέροντας ανοίγει το παλιό σκονισμένο βιβλίο και λέει στο μικρό μαθητή: "Σήμερα θα μελετήσουμε τη μάχη ανάμεσα σε δύο μεγάλους στρατηγούς: ${white}, εναντίον ${black}. Ήταν, είπε, ${formattedDate}, όταν βρέθηκαν απέναντι για αυτή την αναμέτρηση,...n\. Και γυρνώντας την παλιά σελίδα ξεκίνησε να διαβάζει...\n." `;
