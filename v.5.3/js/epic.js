...
phrase += `${opening}, ${pieceAssoc} ${action} ${locus} και ${targetAssoc}, με την κίνηση ${sanText}.\n`;
    ...
    const prologue = `Ο Γέροντας ανοίγει το παλιό σκονισμένο βιβλίο και λέει στο μικρό μαθητή: "Σήμερα θα μελετήσουμε τη μάχη ανάμεσα στους δύο προαναφερόμενους μεγάλους στρατηγούς:" ... Και ανοίγοντας το αρχαίο και πολύτιμο βιβλίο, μετροφύλλισε κάποιες σελίδες και ξεκίνησε να διαβάζει...\n `;
