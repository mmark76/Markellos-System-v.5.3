...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function buildEpicSentence(locus, colorW, pieceAssocW, sanW, targetAssocW,
    ...
    const templates = [
      `${locus} από όπου ξεπροβάλλει ${pieceAssocW}, και με την κίνηση ${sanW}, ${targetAssocW}, ... . Από το ίδιο σημείο, ξεπροβάλλει ${pieceAssocB} ..., και με την κίνηση ${sanB}, ${targetAssocB}.`
    ];
