...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function buildEpicSentence(locus, colorW, pieceAssocW, sanW, targetAssocW,
    ...
    const templates = [
      `${locus}, ο λευκός στρατός με ${pieceAssocW}, και την κίνηση ${sanW} φτάνει προ ${targetAssocW}, και τότε ο μαύρος στρατός με ${pieceAssocB} αντιδρά, με την κίνηση ${sanB} και αντιστέκεται μπαίνοντας ${targetAssocB}.`,
      `${locus}, ο λευκός στρατός με ${pieceAssocW}, και την κίνηση ${sanW} καταλαμβάνει την περιοχή ${targetAssocW}, ενώ ο μαύρος στρατός με ${pieceAssocB} απαντά, με την κίνηση ${sanB}, και διεκδικεί εισέρχοντας ${targetAssocB}.`,
      `${locus}, ο λευκός στρατός με ${pieceAssocW}, και την κίνηση ${sanW} προελαύνει προ ${targetAssocW}, αλλά ο μαύρος στρατός με ${pieceAssocB} αντάποκρίνεται, με την κίνηση ${sanB} και αφήνει τα ίχνη του ${targetAssocB}.`,
      `${locus}, ο λευκός στρατός με ${pieceAssocW}, και την κίνηση ${sanW} κινείται προ ${targetAssocW}, αλλά ο μαύρος στρατός με ${pieceAssocB} αντιδρά, με την κίνηση ${sanB}, αντιδρά και μπαίνει ${targetAssocB}, .`
    ];
