...
phrase += `${opening}, ${pieceAssoc} ${action} ${locus} και ${targetAssoc}, με την κίνηση ${sanText}.\n`;
    ...
    const prologue = `"Ο Γέροντας ανοίγει το παλιό σκονισμένο βιβλίο και λέει στο μικρό σκακιστή ...:\n "Σήμερα θα μελετήσουμε τη μάχη ανάμεσα στους δύο προαναφερόμενους μεγάλους στρατηγούς:" ... Και ανοίγοντας το αρχαίο και πολύτιμο βιβλίο, μετροφύλλισε κάποιες σελίδες και ξεκίνησε να διαβάζει...\n `;
    
    let finalMsg = "";
    if (result === "1-0") finalMsg = "\n … και μετά την τελευταία κίνηση, ο μαύρος Στρατηγός κατάλαβε πως η μάχη είχε κριθεί. Έσκυψε το κεφάλι του αργά, και δίνοντας το χέρι του στον αντίπαλο Στρατηγό, παραδόθηκε με αξιοπρέπεια. Και τότε, επικράτησε ηρεμία από την ηχώ της μάχης, και ο Γέροντας έκλεισε το παλιό σκονισμένο βιβλίο και έτσι η παρτίδα έγινε ανάμνηση για πάντα στη μνήμη και την ιστορία.";
    else if (result === "0-1") finalMsg = "\n … και μετά την τελευταία κίνηση, ο λευκός Στρατηγός κατάλαβε πως η μάχη είχε κριθεί. Έσκυψε το κεφάλι του αργά, και δίνοντας το χέρι του στον αντίπαλο Στρατηγό, παραδόθηκε με αξιοπρέπεια. Και τότε, επικράτησε ηρεμία από την ηχώ της μάχης, και ο Γέροντας έκλεισε το παλιό σκονισμένο βιβλίο και έτσι η παρτίδα έγινε ανάμνηση για πάντα στη μνήμη και την ιστορία.";
