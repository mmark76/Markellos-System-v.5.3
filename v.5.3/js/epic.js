...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function buildEpicSentence(locus, colorW, pieceAssocW, sanW, targetAssocW,
    ...
    const templates = [
      ...
      `${locus} όπου ο λευκός στρατός με ${pieceAssocW}, και την κίνηση ${sanW} κινείται προ ${targetAssocW}, αλλά ο μαύρος στρατός με ${pieceAssocB} αντιδρά, με την κίνηση ${sanB}, αντιδρά και μπαίνει ${targetAssocB}, .`
    ];
