...
let phrase = `${sceneNumber}: `; phrase += `${opening}, ${pieceAssoc} ${action} ${locus} και ${targetAssoc}, με την κίνηση ${sanText}.\n`;
...
stories.push(phrase.trim());
    ...
    const prologue = `"Ο Γέροντας ανοίγει το παλιό σκονισμένο βιβλίο και λέει στο μικρό σκακιστή ..."\n "Σήμερα θα μελετήσουμε τη μάχη ανάμεσα στους δύο μεγάλους στρατηγούς:" ... Και ανοίγει το αρχαίο και πολύτιμο βιβλίο, μετροφυλλάει κάποιες σελίδες και ξεκινάει να διαβάζει...\n `;
