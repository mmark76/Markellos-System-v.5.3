...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function buildEpicSentence(locus, colorW, pieceAssocW, sanW, targetAssocW,
    ...
    const templates = [
      ...
      `${locus} όπου ο λευκός στρατός με ${pieceAssocW}, και την κίνηση ${sanW}, ... ${targetAssocW}, και τότε ο μαύρος στρατός με ${pieceAssocB} απαντά, με την κίνηση ${sanB}, και ${targetAssocB}.`,
      `${locus} όπου ο λευκός στρατός με ${pieceAssocW}, και την κίνηση ${sanW}, ... ${targetAssocW}, αλλά ο μαύρος στρατός με ${pieceAssocB} απαντά, με την κίνηση ${sanB} και ${targetAssocB}.`,
