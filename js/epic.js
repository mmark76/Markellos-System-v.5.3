...
const opening = i === 0 ? "Ο Γέροντας ξεκινάει την αφήγηση και διαβάζει ... Η μάχη ξεκινάει αργά το απόγευμα. Οι δύο Στρατηγοί δίνουν τα χέρια, ακούγεται μία σάλπιγγα και" : openings[i % openings.length];
const action = verbs[i % verbs.length];

let sceneNumber = i + 1;
const sanLabel = `${sceneNumber}. ${sanText}`;
const t1Header = `♞♟ - Half-move ${sanLabel}. Η σκηνή όπου εμφανίζονται ${locus} και ${pieceAssoc}.`;
...
stories.push(phrase.trim());
    ...
    else if (result === "0-1") finalMsg = "\n … και μετά την τελευταία κίνηση, ο λευκός Στρατηγός κατάλαβε πως η μάχη είχε κριθεί. Έσκυψε το κεφάλι του αργά, και δίνοντας το χέρι του στον αντίπαλο Στρατηγό, αποδέχτηκε με αξιοπρέπεια την ήττα ... και ο Γέροντας κλείνει το χοντρό βιβλίο ... και η παρτίδα γίνεται ανάμνηση και για πάντα χαράσσεται στη μνήμη ... και το έπος γράφτηκε στην ιστορία.";
    else if (result === "1/2-1/2") finalMsg = "\n … και μετά την τελευταία κίνηση, οι δύο Στρατηγοί καταλαβαίνουν ότι κανείς δεν μπορεί να κερδίσει αυτή τη μάχη ... και έτσι δίνουν τα χέρια και η μάχη λήγει ισόπαλη ... και ο Γέροντας κλείνει το χοντρό βιβλίο ... και η παρτίδα γίνεται ανάμνηση και για πάντα χαράσσεται στη μνήμη ... και το έπος γράφτηκε στην ιστορία.";
