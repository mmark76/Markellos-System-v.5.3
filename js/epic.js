...
let sceneNumber = i + 1;
const t1Header = `"Half-move ${sceneNumber}. ${sanText}". ${targetAssoc}. \n - Σκηνή: Στο πεδίο της μάχης, στην περιοχή ${square}, όπου βρίσκεται ${targetAssoc}, εμφανίζεται ${locus}.`;
...
stories.push(phrase.trim());
    ...
    const prologue = `♟. "Ο Γέροντας παίρνει στα χέρια του με ηρεμία και μεγάλη προσοχή το χοντρό βιβλίο με τις πολλές ιστορικές παρτίδες και λέει στο μικρό σκακιστή ...\n\n Σήμερα θα μελετήσουμε μία πολύ ενδιαφέρουσα μάχη. ... και ανοίγει το εξώφυλλο, μετροφυλλάει κάποιες σελίδες και ξεκινάει να διαβάζει. Είναι αργά το απόγευμα. Οι δύο Στρατηγοί δίνουν τα χέρια, και η μάχη ξεκινάει. `;
